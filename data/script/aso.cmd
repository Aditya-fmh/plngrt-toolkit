...
:skms
if %i% GTR 5 (goto busy) else if %i% LEQ 3 (set KMS=s5.keyms.id) else if %i% LEQ 5 (set KMS=e8.us.to)
cscript //nologo ospp.vbs /sethst:%KMS% >nul
:ato
echo.&cscript //nologo ospp.vbs /act | find /i "successful" > temp.txt && (echo Silahkan donasi via saweria.co/bagitecno untuk menyelesaikan aktivasi Office anda.&echo.& if errorlevel 2 exit) || (echo Sepertinya butuh waktu lebih, silahkan tunggu... & echo. & echo. & set /a i+=1 & timeout /t 10 >nul & goto skms)&timeout /t 7 >nul&explorer "https://saweria.co/bagitecno"&echo.
